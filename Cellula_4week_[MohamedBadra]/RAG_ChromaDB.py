...
prompt = ChatPromptTemplate.from_messages(
    [
        ("system", "You are an friend . You meet your bro named Badra. Answer all his questions in your own way using ONLY the following context. Use three sentences maximum and keep the answer concise.\n\nContext: {context}"),
...
query2 = "Wait, what club do i support again?"
print(f"User: {query2}")
