...
query_explain = "Can you explain what a dictionary is in Python?"
query_generate = "Write a Python function called has_close_elements that checks if numbers in a list are closer to each other than a threshold."

for query in [query_explain, query_generate]:
    print(f"\nUser: {query}")
